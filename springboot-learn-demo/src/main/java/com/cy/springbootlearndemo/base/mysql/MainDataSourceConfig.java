package com.cy.springbootlearndemo.base.mysql;
...
//@Configuration
@MapperScan(annotationClass = Mapper.class, basePackages = {"com.cy.springbootlearndemo.mapper"}, sqlSessionFactoryRef =
